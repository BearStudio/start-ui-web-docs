...
In StartUI, tRPC allows communication between client and server, ensuring type safety.
...
and automation features. StartUI end-to-end tests are written using Playwright.
...
[React Email](https://github.com/chromakode/react-html-email) is a framework for building responsive email templates with React,
offering an intuitive approach to email design.

[GitHub](https://github.com/chromakode/react-html-email) · [License MIT](https://github.com/chromakode/react-html-email/blob/master/LICENSE)
...
[MailDev](https://github.com/maildev/maildev) is an SMTP server and web interface for email testing in development,
