...
repository. The .env file is created when you execute the "getting started" steps of StartUI's README.md

### Edit an environment variable

1. Change the value in the `.env` file and save the file
2. Depending on the environment variable, the change could have take effect immediately
3. If necessary, change the example value in the `.env.example` to help your colleagues having the right values by default
