...
|-------------|---------------------------------------|-----------------------------------------------------------------------------------|
| `key`       | Language code                         | `'ar'` for Arabic                                                                 |
| `dir`       | Text direction for the language       | `'rtl'` for right-to-left (like Arabic), `'ltr'` for left-to-right (like English) |
| `fontScale` | Scale factor for font size adjustment | `1.2` for Arabic                                                                  |
