...
Allows to debug and design emails without sending them to real inbox. This will allow quicker debug loop and prevent you to be tag as spammer by your STMP because it's hard to do nice styles without sending a lot of emails 😅.
