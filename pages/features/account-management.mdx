...
<Callout type="info" emoji="ℹ️">
  As for the other pages, this is mapped by default to a JHipster API. The code corresponding to this page
  is in the `src/spa/account/PageProfile.tsx` component.
</Callout>
...
import profileDesktopImage from '../../public/images/screenshots/account-management/profile-desktop.png';
import profileMobileImage from '../../public/images/screenshots/account-management/profile-mobile.png';
...
<Callout type="info" emoji="ℹ️">
  As for the other pages, this is mapped by default to a JHipster API. The code corresponding to this page
  is in the `src/spa/account/PagePassword.tsx` component.
</Callout>
...
import passwordChangeDesktopImage from '../../public/images/screenshots/account-management/password-change-desktop.png';
import passwordChangeMobileImage from '../../public/images/screenshots/account-management/password-change-mobile.png';
